...
def run_supervised_curriculum(initial_model_path: str, initial_vec_path: str,
    ...
    while True:
        ...
        if result["reason"] == "phase_advanced":
            ...
            # Inject Optuna's findings into the next phase's hyperparams
            ...
            print(f"[Supervisor] Phase {next_phase + 1} hyperparams updated: "
                  f"{config.PHASE_HYPERPARAMS[next_phase]}")
