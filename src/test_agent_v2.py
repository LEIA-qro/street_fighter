...
def test_agent():
    ...
    env = StreetFighterEnvV2(lua_path = config.MATCH_TEST_ENV_CLIENT_LUA_PATH , trainable = False, rank=0, player=2) # Player 1 controls the agent, Player 2 is the dummy opponent
