...
OPTUNA_DIR = os.path.join(MODEL_DIR, "optuna_best")
...
def objective(trial):
    ...
    try:
        ...
        model.learn(
            ...
            tb_log_name=f"Optuna_RYUMAIN_Trial_{trial.number}"
    ...
    best_path = os.path.join(OPTUNA_DIR, "best_reward.txt")
    ...
    if mean_reward > best_reward:
        ...
        model.save(os.path.join(OPTUNA_DIR, "best_ppo_sf2"))

        env.save(os.path.join(OPTUNA_DIR, "best_vec_normalize.pkl"))
